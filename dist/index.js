...
const distPath = (0, resolvePath_1.default)(path_1.default.dirname(options.dist), (options === null || options === void 0 ? void 0 : options.baseDir) || options.src);
...
function run() {
    try {
        ...
        (0, startPack_1.default)(srcPath).then(res => {
            ...
            console.log(`Resources Packed : ${path_1.default.join(distPath, outFilename + ext)}`);
        }).catch(console.error);
    }
    catch (error) {
        console.error(error);
